...
using binomial_heap_ss = heap<boost::heap::binomial_heap, std::string, std::string>;
...
using binomial_heap_sd = heap<boost::heap::binomial_heap,std::string, double>;

using binomial_heap_ds = heap<boost::heap::binomial_heap,double, std::string>;
